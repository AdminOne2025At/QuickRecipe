  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogTrigger asChild>
        <Button 
          className="fixed bottom-12 right-4 rounded-full p-3 shadow-lg bg-secondary hover:bg-secondary-dark hover:scale-110 transition-all duration-300 animate-bounce"
