...
main() {
  echo -e "${BLUE}=========================================${NC}"
  echo -e "${YELLOW}  ʕ •ᴥ• ʔ  بناء تطبيق كويك ريسب للأندرويد     ${NC}"
  echo -e "${BLUE}=========================================${NC}"
  ...
  if [ "$SKIP_APK_BUILD" = false ]; then
    build_apk
    echo -e "${BLUE}=========================================${NC}"
    echo -e "${GREEN}  ʕ •ᴥ• ʔ  تم إنشاء تطبيق كويك ريسب بنجاح!   ${NC}"
    echo -e "${BLUE}=========================================${NC}"
    echo -e "يمكنك الآن تثبيت الملف ${YELLOW}QuickRecipe.apk${NC} على جهاز أندرويد"
  else
    echo -e "${BLUE}=========================================${NC}"
    echo -e "${GREEN}  ʕ •ᴥ• ʔ  تم إعداد المشروع بنجاح!   ${NC}"
    echo -e "${BLUE}=========================================${NC}"
